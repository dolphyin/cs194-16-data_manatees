...
f_classification = feature_selection.univariate_selection.f_classif(features, output)
print f_classification[1]

f_reg = feature_selection.univariate_selection.f_regression(features, output)
print f_reg[1]
